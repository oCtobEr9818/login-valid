...
(function () {
  ...
  var gb = (function () {
    ...
    Oa = 1,
    la = ab ? Sa / Oa : 1,
    Y = function (h, n, r, w, v, B, A, J, K, O, X, T, P) {
      "undefined" === typeof P && (P = 1);
      A = A || 0;
      J = J || "black";
      var G = 15 < w - n && 15 < v - r ? 8 : 0.35 * Math.min(w - n, v - r);
      h.beginPath();
      h.moveTo(n, r);
      h.save();
      h.fillStyle = B;
      ...
      0 < A &&
        ...
        (h.strokeStyle = J),
        h.moveTo(n, r),
        h.rect(n - P, r - P, w - n + 2 * P, v - r + 2 * P),
        h.stroke());
      h.restore();
      !0 === K &&
        (h.save(),
        ...
        h.lineTo(w, r),
        h.closePath(),
        (A = h.createLinearGradient((w + n) / 2, r + G, (w + n) / 2, r)),
        A.addColorStop(0, B),
      ...
      !0 === X &&
        ...
        h.lineTo(n, v),
        h.closePath(),
        (A = h.createLinearGradient(n + G, (v + r) / 2, n, (v + r) / 2)),
        A.addColorStop(0, B),
  ...
  G.prototype.set = function (h, n, r) {
  ...
  G.prototype.addTo = function (h, n, r, w) {
  ...
  G.prototype.addEventListener = function (h, n, r) {
    h &&
      n &&
  ...
  G.prototype.dispatchEvent = function (h, n, r) {
  ...
  ja.prototype._getLineWithWidth = function (h, n, r) {
    h = String(h);
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((v = n.y2 - 2 - O.height), (K = "bottom")),
          "left" === this.horizontalAlign
            ? (w = n.x1 + 2)
            : "center" === this.horizontalAlign
            ? (w = n.x1 + n.width / 2 - O.width / 2)
            : "right" === this.horizontalAlign && (w = n.x2 - 2 - O.width - A),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((w = n.x1 + 2),
              (v = n.y2 - 2 - (this.maxWidth / 2 - O.width / 2)),
              (B = -90),
              (K = "left"),
              (this.width = O.height),
              (this.height = O.width))
            ...
            ? ((w = n.x2 - 2),
              (v = n.y1 + 2 + (this.maxWidth / 2 - O.width / 2)),
              (B = 90),
              (K = "right"),
              (this.width = O.height),
              (this.height = O.width))
              ...
              if (
                ...
                if ("number" !== typeof m[r].y)
                  ...
                  if (
                    ...
                    var H = k.getMarkerProperties(r, u, n, b);
                    l.push(H);
                    z = X(z);
                    w &&
                      l.push({
              ...
              if (
                ...
                if ("number" !== typeof ga.y)
                  ...
                  0 <= C.dataPointIndexes[f] &&
                    0 !== ga.markerSize &&
                    (0 < ga.markerSize || 0 < C.markerSize) &&
                    ((ka = C.getMarkerProperties(q, g, s, b)),
                    t.push(ka),
                    (f = X(F)),
                    w &&
                      t.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
          ...
          t = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (C ? ba : 1))
              ) << 0
            : 0.3 * this.width;
          f &&
            (t = this.options.dataPointMaxWidth
          ...
          if (0 < v.length)
            for (var E = z._colorSet, t = 0; t < v.length; t++) {
              ...
              if (
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (k + ((C ? ba : 1) * u) / 2 - (C ? A - 1 : 0) * u) << 0
                      : (k - ((C ? ba : 1) * u) / 2 + (C ? A - 1 : 0) * u) <<
                        0),
                    (g = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                  : ((m = a.axisX.reversed
                      ? (h + ((C ? ba : 1) * u) / 2 - (C ? A - 1 : 0) * u) << 0
                      : (h - ((C ? ba : 1) * u) / 2 + (C ? A - 1 : 0) * u) <<
                        0),
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    var S = m.getMarkerProperties(g, s, n, b);
                    f.push(S);
                    var ea = X(u);
                    w &&
                      f.push({
      ...
      function l() {
        ...
        for (var d, e, f, g, k, l, m = 1, s = 0; s < 2 * m; s++) {
          for (
            ...
            (f = I[n]),
            (g = f.textBlock),
            (l = (k = q(n) < R.length ? I[q(n)] : null) ? k.textBlock : null),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
          ...
          if (-1 !== S) {
            ...
            for (F = 0; F < R.length; F++)
              (C = R[F]), ra(P, C, u.fillOpacity), ia.push(C.y1);
            v(P);
            L &&
              u.visible &&
          ...
          if (c && 0 < c.length)
            for (z = [], g = R = 0; g < c.length; g++)
              z.push(
                ...
                (R += z[g]),
                (N += c[g] && !m.isNavigator ? c[g].margin : 0);
          else
            ...
            for (g = 0; g < a.length; g++) {
                ...
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ...
                        : f.y2 - T > m.height - Math.max(N, 10)
                        ? m.height - Math.max(N, 10)
                        : f.y2 - T
                    )
                  : f.y2 > m.height - Math.max(N, 10)
                  ? m.height - Math.max(N, 10)
                  : f.y2;
              if (c && 0 < c.length)
              ...
              if (b && 0 < b.length)
                for (N = 0; N < b.length; N++)
                  b[N] &&
                    b[N].labelAutoFit &&
                    ((n = b[N].lineCoordinates.x1), (l = n - U));
              a[g].lineCoordinates = {
                x1: n - O,
                y1: h,
                x2: n - O,
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (N = 0; N < b.length; N++)
                  b[N] &&
                    b[N].labelAutoFit &&
                    ((n = b[N].lineCoordinates.x2), (l = n - W));
              d[g].lineCoordinates = {
                x1: n + P,
                y1: h,
                x2: n + P,
